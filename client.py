...
def chat_client():
	...
	#If connection from server          
	   ...
	   #If there is a keyboard input
		...
		#If client recieves disconnect client request
	...
	#If connection is on any other socket      
            else :
		data = sock.recv(4096)
		if not data :
	        	print '\nDisconnected from chat server'
			...
			#If client hears file transfer request initiated by other client
			...
			#If session as been closed is notified
